...
export class CharCreator {
     ...
     public static CloseCharCreator(birthday: string): void {
          ...
          alt.emitServer(
               Events.CharCreator.setCharCreatorData,
     ...
     private static getChangedData(count: number, newValue: ICharCreator): string | null {
          ...
          switch (count) {
               ...
               case 1:
                    ...
                    break;
               case 2:
                    changedKeys = Object.keys(CharCreator.previousData.Details).filter(
                         (key) => CharCreator.previousData.Details[key] !== newValue.Details[key],
                    )[0];
                    break;
               case 3:
