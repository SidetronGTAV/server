...
export class System {
    ...
    private static clone(val: any, deep: any = null): any {
        switch (System.typeOf(val)) {
            case 'array':
                return val.slice();
            case 'object':
    ...
    private static cloneTypedArray(val: any, deep: any = null): any {
    ...
    private static isGeneratorFn(name: any, val: any = null): any {
