<template>
     <div v-if="showCharCreator">
          <div class="absolute bottom-10 flex justify-center items-center left-2/4">
               <button class="p-4 border-none rounded-md bg-[#28282AFF] opacity-60 text-white mr-2 text-lg font-bold hover:opacity-100" @click="count--">
                    Zurück
               </button>
               <button class="p-4 border-none rounded-md bg-[#28282AFF] opacity-60 text-white mr-2 text-lg font-bold hover:opacity-100" @click="count++">
                    Weiter
          ...
          <div class="absolute bottom-10 right-6 flex justify-center items-center">
               <button @click="setCharacter" class="p-4 border-none rounded-md text-white bg-[#C72222FF] text-2xl font-bold hover:scale-110">
                    Charakter erstellen
               </button>
          </div>
          <div
